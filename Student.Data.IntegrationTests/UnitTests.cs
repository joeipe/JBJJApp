...
namespace Student.Data.IntegrationTests
{
    ...
    public class UnitTests
    {
        ...
        private Mock<StudentContext> _studentContextMockingContext;
        ...
        public void Setup()
        {
            ...
            _studentContextMockingContext = new Mock<StudentContext>();
            _studentContextMockingContext.Setup(x => x.Set<Grade>()).Returns(TestHelpers.MockDbSet(_gradesInMemory));
            _studentContextMockingContext.Setup(x => x.Set<Person>()).Returns(TestHelpers.MockDbSet(_peopleInMemory));

            _studentData = new StudentData(new GenericRepository<Grade>(_studentContextMockingContext.Object), new GenericRepository<Person>(_studentContextMockingContext.Object));
        }
