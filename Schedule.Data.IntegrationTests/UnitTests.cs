...
namespace Schedule.Data.IntegrationTests
{
    ...
    public class UnitTests
    {
        ...
        private Mock<ScheduleContext> _scheduleMockingContext;
        ...
        public void Setup()
        {
            ...
            _scheduleData = new ScheduleData(new GenericRepository<ClassType>(_scheduleMockingContext.Object), new GenericRepository<TimeTable>(_scheduleMockingContext.Object));
        }
